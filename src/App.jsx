...
export default function App() {
  ...
  // ── Live sync: subscribe to session changes ──
  useEffect(() => {
  ...
  const submitVote = async (type, confusionType) => {
    ...
    if (confusionType) {
      ...
      updates.confusion = {
        ...data.confusion,
        [confusionType]: (data.confusion[confusionType] || 0) + 1,
      };
    } else {
  ...
  const submitConfusion = (type) => {
    submitVote(null, type);
  };
          ...
          <div className="page">
            ...
            <div style={{ flex: 1, display: "flex", flexDirection: "column", justifyContent: "center" }}>
              <div className="badge-live glass" style={{ alignSelf: "flex-start" }}>
                ...
                <span className="badge-text">Built for classrooms that move fast</span>
              </div>
              ...
              <p className="t-sub" style={{ maxWidth: 360, marginBottom: 40 }}>
                ...
                You see the whole class in real time, and AI tells you exactly what to fix.
              </p>
              <div className="role-card glass" onClick={() => go("teacher-setup")} role="button" tabIndex={0}>
                ...
                <div>
                  ...
                  <div className="role-desc">Start a live session — get a room code instantly</div>
                </div>
              </div>
              <div className="role-card glass" onClick={() => go("student-join")} role="button" tabIndex={0}>
                ...
                <div>
                  ...
                  <div className="role-desc">Join with a code — respond in 3 seconds, anonymously</div>
                </div>
              </div>
            </div>
          ...
          <div className="page">
            ...
            <div style={{ marginTop: 24 }}>
              ...
              <div className="card glass">
                ...
                <input
                  className="input"
                  placeholder="e.g. Stoichiometry, The Cold War…"
                  value={topic}
              ...
              <div className="card-sm glass">
                ...
                <p className="t-sub" style={{ fontSize: 13 }}>
                  1. Put the 4-digit room code on the board<br />
                  2. Students tap Got it / Kinda / Lost in 3 seconds<br />
                  3. You see the live breakdown + AI suggestions instantly
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="page">
            <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 28 }}>
              ...
              <div className="badge-live glass" style={{ marginBottom: 0 }}>
                <span className="badge-dot" />
                <span className="badge-text" style={{ fontSize: 11 }}>Live</span>
              </div>
            </div>
            ...
            <div className="card glass">
              ...
              <p className="t-sub" style={{ textAlign: "center", fontSize: 13 }}>Students go to localhost:3000 and enter this code</p>
            </div>
              ...
              {[
                ...
                <div className="bar-row" key={label}>
                  <div className="bar-head">
                    ...
                    <span className={`bar-cnt ${cnt}`}>{val} · {pct(val)}%</span>
                  </div>
                  <div className="bar-track">
                    <div className={`bar-fill ${fill}`} style={{ width: `${pct(val)}%` }} />
                  </div>
                </div>
              ))}
            </div>
            ...
            <button className="btn-ghost" style={{ display: "block", width: "100%", textAlign: "center", marginTop: 8 }} onClick={() => go("home")}>
              End session
            </button>
          </div>
        )}
            ...
            <div style={{ marginTop: 24 }}>
              ...
              <div className="card glass">
                ...
                <input
                  ...
                  onKeyDown={e => e.key === "Enter" && codeInput.length >= 4 && joinRoom()}
                  maxLength={4}
                  inputMode="numeric"
                  autoFocus
                />
        ...
        {screen === "student-vote" && (
          <div className="page">
            ...
            <button className="vote-btn v-got" onClick={() => vote("got")}>
              ...
              <span className="v-sub">Fully following along</span>
            </button>
            <button className="vote-btn v-kinda" onClick={() => vote("kinda")}>
              <span className="v-emoji">〜</span>
              <span className="v-label">Kinda</span>
              <span className="v-sub">Getting it but a little fuzzy</span>
            </button>
            <button className="vote-btn v-lost" onClick={() => vote("lost")}>
              <span className="v-emoji">✗</span>
              <span className="v-label">Lost</span>
              <span className="v-sub">Not following — need help</span>
            </button>
            <p className="t-label" style={{ textAlign: "center", marginTop: 8 }}>Anonymous · 3 seconds</p>
          </div>
        )}
          ...
          <div className="page">
            ...
            {[
              ...
              <div className="fup" key={key} onClick={() => submitConfusion(key)} role="button" tabIndex={0}>
                ...
                <div>
                  <div className="fup-title">{title}</div>
                  <div className="fup-sub">{sub}</div>
                </div>
              </div>
            ))}
            <div className="fup" onClick={() => setOtherOpen(o => !o)} role="button" tabIndex={0}>
              ...
              <div>
                <div className="fup-title">Other — tell us in your own words</div>
                <div className="fup-sub">Tap to write what's confusing you</div>
              </div>
            </div>
            {otherOpen && (
              <div style={{ marginTop: 4, marginBottom: 16 }}>
                <textarea
                  ...
                  placeholder="What's confusing you? (still anonymous)"
                  value={otherText}
        ...
        {screen === "student-done" && (
          <div className="page">
            <div className="success-wrap">
              ...
              <p className="t-sub" style={{ maxWidth: 300 }}>
                Your teacher sees the class breakdown right now. They don't know it was you.
              </p>
              <div className="anon-strip glass">🔒 You're anonymous</div>
              <div style={{ marginTop: 32, width: "100%", maxWidth: 340 }}>
                <button className="btn btn-outline" onClick={() => go("student-vote")}>↺ Change my response</button>
                <button className="btn-ghost" style={{ display: "block", width: "100%", textAlign: "center", marginTop: 8 }} onClick={() => go("home")}>
                  Back to home
                </button>
              </div>
